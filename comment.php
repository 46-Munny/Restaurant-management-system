...
<body class="whole">
  <div class="wrapper mt-4">
      <form action="comment.php" class="form" method="post">
         <div class="row">
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  $query=mysqli_query($conn,"INSERT INTO `ofccomments` ( `owner_id`,`Name`, `Email`, `Comment`) VALUES ('$ownerid','$Name', '$Email', '$Comment')");
   ...
   if($query)
   {
     ...
     echo mysqli_error($conn);
        ...
        $sql1 = "SELECT * FROM `ofccomments` where owner_id='$ownerid'";
