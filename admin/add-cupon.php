...
/*$filename=$files['name'];
 ...
 $sql = "INSERT INTO `cupon` (`Id`, `Name`, `Description`, `Price`, `Status`) VALUES ('$Id', '$Name', '$Desc', '$Taka', '$Status')";
       ...
       <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/js/all.min.js" crossorigin="anonymous"></script>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content"  >
                ...
                <div>
                <div class="row pl-4">
                <h2> <span style="text-align:center;"> Add Cupon</span></h2>
                <div class="col-lg-12">
                </div>
                <div class="card mb-4">
                    <div class="card-header">
                    <a href="add-cupon.php"><button type="button" class="btn btn-danger">Add Cupon</button></a>
                        <a href="view-cupon.php"><button type="button" class="btn btn-warning">View Cupon</button></a>
                    </div>
              </div>
                </div>
                </div>
                    ...
                    <form action="add-cupon.php" method="post" >

                    <div class=" from-group mb-3">
                      <label for="Cupon"form-label">Cupon Id</label>
                      <input type="text"  class="form-control" id="id" name="id" style="width:100%;">
                    </div>


                    <div class=" from-group mb-3">
                      <label for="Name"form-label">Cupon Name</label>
