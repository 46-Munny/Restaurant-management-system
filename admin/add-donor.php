...
/*$filename=$files['name'];
 ...
 $sql = "INSERT INTO `donor` ( `phone`, `name`, `amount`, `address`, `comment`) VALUES ( '$Phn', '$Name', '$Taka', '$Address', '$Comment');";
     ...
     <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content"  >
                ...
                <div>
                <div class="row pl-4">
                <h2> <span style="text-align:center;"> Add Donor</span></h2>
                <div class="col-lg-12">
                </div>
                </div>
                </div>
