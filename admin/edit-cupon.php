...
<html lang="en">
    <head>
        ...
        <title>FoodFun - Edit Cupon</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4 mb-4">Cupons</h1>

                        </div>

                        <div class="card mb-4">
                            <div class="card-header">
                            <a href="add-cupon.php"><button type="button" class="btn btn-danger">Add Cupons</button></a>
                            <a href="view-cupon.php">   <button type="button" class="btn btn-warning">View Cupons</button></a>
                            </div>

                            <div class="container">
                    <h2 class=" text-center mt-4 rtext">Edit Cupon details</h2>
                    <br>
                    ...
                    if(isset($_POST['edit']))
                    {
                        $sql2= "SELECT * FROM `Cupon` WHERE `Id`={$_POST['cid']}";
                    ...
                    <div class="col-lg-8 m-auto d-block">
                        <form class="" action="edit-cupon.php" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ID:<input type="text" name="id" value="<?php echo $result['Id']; ?>"  class="form-control" placeholder="Enter Cupon Id" required>

                        </div>


                        <div class="form-group">
                            Cupon Name:<input type="text" name="name" value="<?php echo $result['Name']; ?>"  class="form-control" placeholder="Enter Cupon Name" required>
                        ...
                        <div class="form-group">
                            Status:<input type="text" name="status" value="<?php echo $result['Status']; ?>"  class="form-control" placeholder="Enter Cupon Status" required>
                        </div>
                    ...
                    $sql1="UPDATE `Cupon` SET `Id` = '$Id',`Name` = '$Name',`Description` = '$Desc',`Price` = '$Taka',`Status` = '$Status' WHERE `Cupon`.`Id` ={$_REQUEST['id']} ";
                    ...
                    if(mysqli_query($con,$sql1))
                    {
                        ...
                        Cupon info Successfully updated</div>";
                    }

                    else{
                        echo " <div class=\"alert alert-success text-center \">
                        Cupon info not updated</div>";
