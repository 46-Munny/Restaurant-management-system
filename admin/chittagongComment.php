         ...
         <div class="row">
            <div class="input-group textarea">
                <label for="category">Category</label>
                  <input type="text" name="category" id="category" placeholder="Enter your category" value="Chittagong"  required>
            </div>
         </div>
  ...
  $query=mysqli_query($conn,"INSERT INTO `comments` ( `Name`, `Email`, `Comment`,`Category`) VALUES ('$Name', '$Email', '$Comment','$Category')");
   ...
   if($query)
   {
     ...
     echo mysqli_error($conn);
        ...
        $sql1 = "SELECT * FROM `comments` where Category='Chittagong'";
