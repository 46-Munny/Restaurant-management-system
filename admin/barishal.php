			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Barishal</h2>
						<p>Barishal is the  city of Bangladesh<br>
						Let's see our Barishal Dishes.</p><br>
				...
				if(isset($_POST['search']))
        {
          ...
          $display=" select * from product where Catagory_Name='Dhaka' and Product_Name  like '%$searchkey%'";
				...
				else if(isset($_POST['offer']))
				{
					...
					$display=" select * from product where Catagory_Name='Barishal' ";
				}
			...
			<div class="center">
					<button class="food-btn"><a href="barishalComment.php">Feedback</a></button>
				</div>
		</div>
