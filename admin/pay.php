...
<body>
        ...
        <form action="pay.php" method="POST">
            ...
            <div class="input-group">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="input-box">
                            <input type="text" placeholder="Food Name" name="foodname" class="name" required>
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="text" placeholder="Food Price" name="price" class="name" required>
  ...
  $sql2="INSERT INTO `orderinfo`( `Name`, `Contact`, `Taka`, `Order_Received`, `Delivery_Time`, `Status`, `item`) VALUES ('$name','$phn','$price','$date','$date','$status','$foodName')";
