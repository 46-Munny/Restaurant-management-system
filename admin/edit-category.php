...
<html lang="en">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="add-category.php"><button type="button" class="btn btn-danger">Add Category</button></a>
                                <a href="view-category.php"><button type="button" class="btn btn-warning">View Category</button></a>
                            </div>

                            <div class="container">
  <h2 class=" text-center mt-4 rtext">Edit Category</h2>
  <br>
  ...
  if(isset($_POST['edit']))
  {
    $sql2= "select * from admincategory where id={$_POST['cid']}";
  ...
  <div class="col-lg-8 m-auto d-block">
    <form class="" action="edit-category.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        Category Name:<input type="text" name="categoryname" value="<?php echo $result['categoryName']; ?>"  class="form-control" placeholder="Enter Category Name" required>

      </div>
      <div class="form-group">
       Sub-category Name:<input type="text" name="subcategoryname" value="<?php echo $result['scategoryName']; ?>"  class="form-control" placeholder="Enter Sub-category Name" required>

      </div>

      <div class="form-group">
        Sub-category Image:<input type="file" name="file"   class="form-control" required>

      </div>

      <div class="form-group">
       Sub-category Page:<input type="text" name="subcategorypage" value="<?php echo $result['scategoryPage']; ?>"  class="form-control" placeholder="Enter Category Page Name" required>
...
$subcpage=$_POST['subcategorypage'];
 ...
 $sql1="update admincategory set id='$id',categoryName='$cname',scategoryName='$subcname',scategoryImage='$destinationfile',scategoryPage='$subcpage', status='$status'
